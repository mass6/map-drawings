...
function initialize() {
    ...
    function remove_marker(marker, index, descriptionArray) {
     ...
     //                marker.setMap(null);
					// //$.growl({ title: "Point removed!", message: "Add more or go to the next page." });
     //            },
 ...
 //############### Save Marker Function ##############
    ...
    //             Marker.setDraggable(false); //set marker to fixed
				// Marker.setIcon('img/custompin_blue.png');
				// //$.growl({ title: "Point saved!", message: "Add more or go to the next page." });
    //         },
    //         error: function (xhr, ajaxOptions, thrownError) {
