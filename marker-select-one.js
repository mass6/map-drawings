...
var EditForm =
    ...
    '<select name="prescategory" id="SelectOne" class="save-selectone form-control">' +
...
$(document).ready(function () {
    ...
    var addSaveClickListener = function(marker, infowindow, contentString)
    {
        ...
        if (typeof saveBtn !== 'undefined') {
            google.maps.event.addDomListener(saveBtn, "click", function (event) {
                ...
                saveMarker(marker, mSelectOne, mDescription);
                infowindow.close();
                map.setOptions({
                    streetViewControl: false
                });
    ...
    function saveMarker(marker, mSelectOne, mDescription) {
