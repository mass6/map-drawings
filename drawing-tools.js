...
//    '<div id="pano-div" style="width:450px;height:200px;background:yellow"></div>' +
//    '<form action=" " method="POST" name="SaveMarker" id="SaveMarker" class="form-inline">' +
//    '<div class="form-group infowindow-wrapper">' +
//
//    '<label for="prescategory">You were: </label>' +
...
//    '</select>' +
//
//    '<label for="pcategory">Conflict with:</label>' +
...
$(document).ready(function () {
    ...
    function getPanorama(element, position, povSetting = null) {
        if (povSetting === null) {
            povSetting = {
                heading: 34,
                pitch: 10
...
//first map
        ...
        google.maps.event.addListener(drawingManager, 'markercomplete', function (marker) {
            ...
            if (typeof saveBtn !== 'undefined') { //continue only when save button is present
                ...
                google.maps.event.addDomListener(saveBtn, "click", function (event) {
                    ...
                    save_marker(marker, markerIndex, panorama, mCategory, mResCategory, mDescription, mReplace);
                    infowindow.close();
    ...
    function save_marker(Marker, markerIndex, panorama, mCategory, mResCategory, mDescription, replaceWin) {
